        ...
        <>
            ...
            {/* <div className="flex flex-wrap place-items-center">
                <section className="relative mx-auto">
                    <nav className="flex justify-between bg-white shadow-lg text-dark w-screen">
                        <div className="px-5 xl:px-12 py-6 flex w-full items-center">
                            ...
                            <ul className="hidden md:flex px-4 mx-auto font-semibold font-heading space-x-12">
                                ...
                                <li><a className="hover:text-gray-900" href="/">Catagory</a></li>
                                <li><a className="hover:text-gray-900" href="/">Collections</a></li>
            ...
            <nav className="bg-white p-4 shadow-lg border lg:px-20">
                <div className="container mx-auto flex justify-between items-center">
                    <div className="text-black text-2xl font-bold">MyLogo</div>
                    <div className="hidden md:flex space-x-4 mx-auto">
                        <a href="/" className="text-black  px-3 py-2 rounded">Home</a>
                        <a href="/" className="text-black  px-3 py-2 rounded">About</a>
                        <a href="/" className="text-black  px-3 py-2 rounded">Services</a>
                        <a href="/" className="text-black  px-3 py-2 rounded">Contact</a>
                    </div>
